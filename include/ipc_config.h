...
#define SIM_BOARD_INTERVAL_US   800000      /* 800ms between each board      */

/* Inspection time simulation per station (microseconds) */
#define SIM_STATION1_DELAY_US   500000      /* Solder check: 500ms           */
#define SIM_STATION2_DELAY_US   400000      /* Placement check: 400ms        */
#define SIM_STATION3_DELAY_US   600000      /* Continuity test: 600ms        */
...
#define SIM_DASHBOARD_REFRESH   1500000     /* Refresh every 1.5 seconds     */
...
#define LOG_MAGIC           0xCB123456U      /* Written to log_header_t.magic */
